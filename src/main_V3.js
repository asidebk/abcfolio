...
const cloud1 = createCloud(0, 8, -1, 4);
const cloud2 = createCloud(1, 8, 2, 4);
const cloud3 = createCloud(2, 8, 1, 4);
...
videoTexture.flipY = false; // << FIX: Correct orientation
...
gltfLoader.load(
  ...
  (gltf) => {
    ...
    if (targetMesh && targetMesh.isMesh) {
        ...
        targetMesh.geometry.computeBoundingBox(); // optional but safe
        const uvAttribute = targetMesh.geometry.attributes.uv;
